...
def build_gpt_prompt(objective: Optional[str], parsed_summary: Optional[str], duration: int) -> str:
    ...
    return (
        ...
        "- Assign exactly one technique per block based on learning efficiency: flashcards, quiz, feynman, blurting, or arlo_teaching, and avoid repeats.\n"
        "- Use Feynman for deep conceptual understanding.\n"
        "- Use flashcards to memorize definitions or key facts.\n"
        "- Use blurting to stress-test memory recall.\n"
        "- Use quizzes to reinforce weak areas and check comprehension.\n"
        "- Follow this mapping unless content clearly requires otherwise.\n"
